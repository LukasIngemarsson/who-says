...
This script:
1. Loads reference speaker audio files from data/benchmark/speaker_references/
2. Extracts segments from benchmark JSON files using data/benchmark/combined.mp3
...
def main():
    # Paths
    reference_dir = "data/benchmark/speaker_references"
    benchmark_dir = "data/benchmark/annotations"
    audio_file = "data/benchmark/data/benchmark/combined.mp3"
